...
public class LegacyNumPanel extends JPanel {
	...
	public LegacyNumPanel(String name, int value) {
		this(name, value, 0, 100);
	}

	public LegacyNumPanel(String name, int value, int minimum, int maximum) {
