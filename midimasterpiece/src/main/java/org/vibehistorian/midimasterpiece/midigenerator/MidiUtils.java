...
public class MidiUtils {
	...
	public static final String[] CHORD_INST_NAMES = { "PIANO = 0", "BRIGHT_ACOUSTIC = 1",
			...
			"XYLOPHONE = 13", "ORGAN = 16", "ORGAN2 = 17", "STEEL_GUITAR = 25", "CLEAN_GUITAR = 27",
			"ACOUSTIC_BASS = 32", "FINGERED_BASS = 33", "PICKED_BASS = 34", "FRETLESS_BASS = 35",
			"SLAP_BASS = 36", "TREMOLO_STRINGS = 44", "PIZZICATO_STRINGS = 45", "HARP = 46",
			"STRINGS = 48", "STRING_ENSEMBLE_2 = 49", "BASSOON = 70", "FANTASIA = 88", };
	
	public static final String[] PLUCK_INST_NAMES = { "PIANO = 0", "BRIGHT_ACOUSTIC = 1",
			"HONKYTONK = 3", "EPIANO = 4", "EPIANO2 = 5", "CELESTE = 8", "MUSIC_BOX = 10",
			"VIBRAPHONE = 11", "MARIMBA = 12", "XYLOPHONE = 13", "TUBULAR_BELL = 14",
			"NOTHING = 15", "STEEL_GUITAR = 25", "CLEAN_GUITAR = 27", "ACOUSTIC_BASS = 32",
			"FINGERED_BASS = 33", "PICKED_BASS = 34", "FRETLESS_BASS = 35", "SLAP_BASS = 36",
	...
	static {
		...
		INST_POOLS.put(POOL.ALL, combineInstrumentPools(PLUCK_INST_NAMES, CHORD_INST_NAMES,
				BASS_INST_NAMES, LONG_INST_NAMES));
	}
